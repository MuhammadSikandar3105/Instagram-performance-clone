...
const CreatePosition = ({ children }) => {
  ...
  return (
    <div className="bg-[#00000076] w-full h-full absolute top-1/2 -translate-y-1/2">
      <div
        className={`max-w-[557px] max-h-[557px] overflow-hidden w-full h-full top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 rounded-[16px] searchmodalshadow modalbg text-secondary absolute 
         ${darkTheme && "darkmode"}`}
